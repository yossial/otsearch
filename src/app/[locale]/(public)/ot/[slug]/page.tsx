...
import { getOTBySlug } from '@/lib/mock-data';
        ...
        <div className="mb-6 flex flex-col gap-4 rounded-lg bg-surface p-6 shadow-card sm:flex-row sm:items-start">
          ...
          <div className="flex flex-1 flex-col gap-2">
            <div className="flex flex-wrap items-start gap-3">
              <div>
                <h1 className="text-2xl font-bold text-text-primary">{ot.name}</h1>
                <p className="text-base text-text-secondary">{ot.titleHe}</p>
              </div>
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start">
          ...
          <div className="flex flex-1 flex-col gap-6">
            ...
            <section className="rounded-lg bg-surface p-6 shadow-card">
              ...
              <p className="leading-relaxed text-text-secondary">{ot.bio}</p>
            </section>
          ...
          <aside className="flex flex-col gap-4 md:w-72 md:flex-shrink-0">
            ...
            <div className="rounded-lg bg-surface p-5 shadow-card">
              ...
              <div className="mb-4 flex items-baseline gap-1">
                ...
                <span className="text-sm text-text-muted">{t('fees').replace('Session fees', 'לטיפול').replace('עלות טיפול', 'לטיפול')}</span>
              </div>
              ...
              <p className="mb-4 text-center text-xs text-text-muted">{ot.phone}</p>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {ot.insurance.map((ins) => (
                    <span
                      key={ins}
                      className="rounded-full bg-bg-alt px-2.5 py-1 text-xs font-medium text-text-secondary"
                    >
