    ...
    <section id="pricing" className="bg-surface py-20">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <StaggerList className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <StaggerItem>
            <div className="flex h-full flex-col rounded-2xl border border-border bg-surface p-8">
              ...
              <div className="mt-auto pt-8">
                <Link
                  href="/auth/register"
                  className="block w-full rounded-xl bg-primary py-3 text-center text-sm font-bold text-white transition-colors hover:bg-primary-mid"
                >
                  {t('freeCta')}
                </Link>
              </div>
          ...
          <StaggerItem>
            <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border-2 border-accent bg-surface p-8">
              {/* Coming soon ribbon */}
              ...
              <div className="mt-auto pt-8">
                <button
                  type="button"
                  disabled
                  className="block w-full cursor-not-allowed rounded-xl border-2 border-accent py-3 text-center text-sm font-bold text-accent opacity-50"
                >
                  {t('premiumCta')}
                </button>
              </div>
